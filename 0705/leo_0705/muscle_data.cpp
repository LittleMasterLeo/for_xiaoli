#include "muscle_data.h"
#include "ui_muscle_data.h"

muscle_data::muscle_data(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::muscle_data)
{
    ui->setupUi(this);
}
...
void muscle_data::on_start_Button_clicked()
{
    Recvdata();
}
