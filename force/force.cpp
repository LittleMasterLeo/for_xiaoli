...
void forceControl(UrDriver *ur3, std::condition_variable *rt_msg_cond_, int run_time, int force_mode, double user_parameters[6], double f_ref, double t_ref)
{
	...
	//forcelog.open("../data/logs/forcelog", std::ofstream::out);
        forcelog.open("/home/xiaoli/Documents/xiaoli/data_xiaoli/logs/forcelog.csv", std::ofstream::out);
	std::ofstream leo_test;
		leo_test.open("/home/xiaoli/Documents/xiaoli/data_xiaoli/logs/leo_test.txt", std::ofstream::out);
...
void forceTune(UrDriver *ur3, std::condition_variable *rt_msg_cond_, int run_time, double f_ref, double t_ref)
{
	...
	std::ofstream forcelog;
	//forcelog.open("../data/logs/forcelog", std::ofstream::out);
        forcelog.open("/home/xiaoli/Documents/xiaoli/data_xiaoli/logs/forceTunelog", std::ofstream::out);
