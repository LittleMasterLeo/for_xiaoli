...
int get_force_mode;
int set_k = 0;
double force_data[3] = {0};
double vector_data[3] = {0};
int robot_data_ready = 0;
...
/////////////////////////////////////////////////////////////////
		...
		//
		robot_data_ready = 0;
		memcpy(force_data, forces, sizeof(force_data));
		vector_data[0] = gsl_vector_get(O,0);
		vector_data[1] = gsl_vector_get(O,1);
		vector_data[2] = gsl_vector_get(O,2);
		robot_data_ready = 1; 
